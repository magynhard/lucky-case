...
if (typeof require === 'function') {
    var InvalidCaseError = require('./custom-errors/invalid-case-error.js');
    var InvalidConstantError = require('./custom-errors/invalid-constant-error.js');
}
//<!-- /MODULE -->//
/**
 * LuckyCase
